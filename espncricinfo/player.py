...
class Player(object):
    ...
    def get_career_averages(self, file_name=None, match_format=11, data_type='allround') :
        ...
        if self.file_name is None:
            self.file_name = f"player_data/{self.player_id}_{self.data_type}_career_averages.csv"
    ...
    def get_career_summary(self, file_name=None, match_format=11, data_type='allround'):
        ...
        if self.file_name is None:
            self.file_name = f"player_data/{self.player_id}_{self.data_type}_career_summary.csv"
    ...
    def get_data(self, file_name=None, match_format=11, data_type='allround', view='match'):
        ...
        if self.file_name is None:
            self.file_name = f"player_data/{self.player_id}_{self.data_type}_{self.view}.csv"
